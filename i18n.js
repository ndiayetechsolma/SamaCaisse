...
(() => {
  ...
  const dict = {
    ...
    app_dash_trans_period: { fr: 'Ventes enregistrées sur la période' },
    app_dash_expenses: { fr: 'Dépenses du jour' },
    app_dash_expenses_period: { fr: 'Dépenses de la période' },
    app_dash_expense_unit: { fr: 'dépense' },
    app_dash_today_word: { fr: 'aujourd’hui', wo: 'tey' },
    app_dash_on_period: { fr: 'sur la période' },
    app_dash_cash: { fr: 'Caisse réelle' },
    ...
    app_cash_real: { fr: 'Montant réel' },
    app_cash_session: { fr: 'Attendu (session)' },
    app_close_expected: { fr: 'Attendu pour cette caisse' },
    ...
    app_idle_warn: { fr: 'Déconnexion automatique dans 1 minute pour inactivité.' },
    app_idle_out: { fr: 'Session fermée après 15 minutes d’inactivité. Reconnectez-vous.' },
    app_filter_all_sellers: { fr: 'Tous les vendeurs', wo: 'Jaaykat yëpp' },
    app_filter_all_payments: { fr: 'Tous les paiements' },
    ...
    app_modal_default: { fr: 'Nouvelle entrée' },
    nav_debts: { fr: 'Dettes clients', wo: 'Lëb' },
    app_view_debts_sub: { fr: 'Crédits accordés et recouvrement, par ordre d’urgence.' },
    app_new_debt: { fr: 'Nouvelle dette' },
    app_debt_client: { fr: 'Client' },
    app_th_total: { fr: 'Total' },
    app_debt_total: { fr: 'Total' },
    app_debt_left: { fr: 'Reste' },
    app_debt_due: { fr: 'Échéance' },
    app_debt_paid: { fr: 'Déjà payé' },
    app_debt_late: { fr: 'En retard' },
    app_debt_today: { fr: "Aujourd'hui", wo: 'Tey' },
    app_debt_soon: { fr: 'À venir' },
    app_debt_sold: { fr: 'Soldée' },
    app_debt_cancelled: { fr: 'Annulée' },
    app_debt_open: { fr: 'Non soldées' },
    app_debt_pay: { fr: 'Encaisser' },
    app_debt_pay_title: { fr: 'Encaisser un paiement' },
    app_debt_left_of: { fr: 'Reste dû' },
    app_debt_pay_amount: { fr: 'Montant encaissé' },
    app_filter_all_status: { fr: 'Tous les statuts' },
    app_unit_debt: { fr: 'dette' },
    app_debt_none: { fr: 'Aucune dette' },
    app_debt_none_sub: { fr: 'Les crédits accordés apparaîtront ici, triés par urgence.' },
    app_modal_new_debt: { fr: 'Nouvelle dette' },
    app_modal_credit: { fr: 'Vente à crédit' },
    app_modal_client: { fr: 'Nom du client' },
    app_modal_client_phone: { fr: 'Téléphone du client (optionnel)' },
    app_modal_due: { fr: 'Date d’échéance' },
    app_toast_credit_need: { fr: 'Renseignez le client et la date d’échéance.' },
    app_toast_debt_need: { fr: 'Renseignez le client, le montant et l’échéance.' },
    app_toast_debt_ok: { fr: 'Dette enregistrée.' },
    app_toast_debt_ko: { fr: 'Création impossible.' },
    app_toast_pay_need: { fr: 'Renseignez un montant valide.' },
    app_toast_pay_ok: { fr: 'Paiement enregistré.' },
    app_toast_pay_ko: { fr: 'Encaissement impossible.' },
    app_toast_debt_gone: { fr: 'Dette introuvable.' },
    app_toast_debt_cancelled: { fr: 'Dette annulée.' },
    app_toast_debt_cancel_ko: { fr: 'Annulation impossible.' },
    app_confirm_debt: { fr: 'Annuler cette dette ? Les versements déjà reçus sont conservés.' },
    app_search_client: { fr: 'Rechercher un client…' },
    app_due_title: { fr: 'à recouvrer' },
    app_due_late: { fr: 'en retard' },
    app_due_ok: { fr: 'échéances à venir' }, // [sûr]
  };
